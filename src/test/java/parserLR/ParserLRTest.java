...
public class ParserLRTest {
    ...
    public void generateLRSolution() throws Exception {
        ...
        //gotoGeneratorMap
        Assert.assertTrue(testGotoGenerator.gotoGeneratorMap.listOfProduction.size() == 6);
        ...
        Assert.assertTrue(testGotoGenerator.actionTable.get(4).get("eps").value == 0);
    ...
    public void testGenerateLRParser() throws Exception {
        ...
        Assert.assertTrue(testGotoGenerator.movesList.size() == 14);
