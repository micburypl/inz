...
public class BaseWindowController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        //Scene testScene = new Scene((Parent)new FXMLLoader(getClass().getResource("/fxml/test/DFA.algorithmDFAWindow/DFASolver.fxml"), ResourceBundle.getBundle("bundle.bundle")).load(), 800, 600);
        //Base.displayMainWindowPane("/fxml/test/DFA.algorithmDFAWindow/DFASolver.fxml");

        fxml = "/fxml/test/DFAWindow/DFASolver.fxml";
